...
export default function Page() {
  return (
    <main className="container space-y-16 p-24">
      ...
      <section className="space-y-4 text-center">
        ...
        <div className="mx-auto !mt-8 grid max-w-[80ch] grid-cols-1 gap-4">
          <a
      ...
      <section className="space-y-4 text-center">
        ...
        <div className="mx-auto grid max-w-[80ch] grid-cols-2 gap-4">
          <a
